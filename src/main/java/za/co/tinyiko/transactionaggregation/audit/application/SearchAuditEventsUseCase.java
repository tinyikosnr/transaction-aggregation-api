 ...
 * contract - see CLAUDE.md). The only audit-read capability this branch implements: no
 * get-by-id, matching the "queries" (plural, search-shaped) wording rather than inventing a
 * singular resource lookup nothing names.
 */
